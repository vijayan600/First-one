...
import vijayAnand from "../assets/developed_team/vijay-anand.jpg";
import vipin from "../assets/developed_team/vipin.jpg";
  ...
  return (
    <footer className="app-footer">
      ...
      <div className="footer-container">
        {/* Top Section: Association Info (Left) + Instagram (Right) */}
        <div className="footer-top-section">
          <div className="footer-info-left">
            <h3 className="association-name">Science & Humanities Association</h3>
        ...
        <div className="footer-content">
          <p className="footer-designed">© DESIGNED BY WEB DEVELOPMENT TEAM 2025-26</p>
          ...
          <div className="footer-team-small">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className={`team-member-info ${activeCard === index ? 'active' : ''}`}>
                  <h4>{member.name}</h4>
          ...
          <p className="footer-copyright">
            ©2026 All Rights Reserved by Science & Humanities Association
          </p>
        </div>
      </div>
    </footer>
